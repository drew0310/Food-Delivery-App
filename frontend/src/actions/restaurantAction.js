...
//allows to use Axios to make HTTP requests
import axios from "axios";

import { ALL_RESTAURANTS_FAIL, ALL_RESTAURANTS_SUCCESS, ALL_RESTAURANTS_REQUEST, CLEAR_ERRORS, SORT_BY_RATINGS, SORT_BY_REVIEWS, TOGGLE_VEG_ONLY } from "../constants/restaurantConstant";
